...
DomainErrorTranslator._directories = {
  ...
  'NEW_REPLY.PAYLOAD_NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('balasan tidak valid'),
  'NEW_REPLY.PAYLOAD_NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('balasan tidak valid'),
